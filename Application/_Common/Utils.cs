    ...
    public class Utils
    {
        ...
        public static string FormatHtml(string url, string lang, int linkExpireHours, string webUrl, string cdcUrl, string vaccineFAQUrl, string covidWebUrl, string emailLogoUrl)
        {
            ...
            return lang switch
            {
                "es" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Consulte la información más reciente</a> sobre la COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "zh" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>保持关注。</h2>" +
                    $"<p><a href='{covidWebUrl}'>查看 COVID-19 最新信息</a>。</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "zh-TW" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>保持關注。</h2>" +
                    $"<p><a href='{covidWebUrl}'>檢視 COVID-19 最新資訊</a>。</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ko" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>최신 정보를 확인하십시오.</h2>" +
                    $"<p>COVID-19 관련 <a href='{covidWebUrl}'>최신 정보 보기</a></p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "vi" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Xem thông tin mới nhất</a> về COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "tl" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Tingnan ang pinakabagong impormasyon</a> tungkol sa COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ru" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Получайте актуальную информацию</a> о COVID-19 .</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ja" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>最新の情報を入手する </h2>" +
                    $"<p>新型コロナ感染症について<a href='{covidWebUrl}'>最新情報を見る</a>。</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "fr" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>Informez-vous.</h2>" +
                    $"<p><a href='{covidWebUrl}'>Voir les dernières informations</a> à propos du COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "tr" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                   ...
                   $"<p>COVID-19 <a href='{covidWebUrl}'>hakkında en güncel bilgileri görüntüleyin</a>.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                   $"<hr>" +
                ...
                "uk" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Перегляньте найновішу інформацію</a> про COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ro" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Vizualizați cele mai recente informații</a> referitoare la COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "pt" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Veja as informações mais recentes</a> sobre a COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
               ...
               "hi" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>सूचित रहें।</h2>" +
                    $"<p>COVID-19 के बारे में <a href='{covidWebUrl}'>नवीनतम जानकारी देखें</a>। </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "de" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Sehen Sie sich die neuesten Informationen</a> über COVID-19 an.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ti" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>ሓበሬታ ሓዙ።</h2>" +
                    $"<p>ብዛዕባ ኮቪድ-19 <a href='{covidWebUrl}'>ናይ ቀረባ ግዜ ሓበሬታ ራኣዩ</a> ኢኹም።</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
               ...
               "te" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p>కొవిడ్-19పై <a href='{covidWebUrl}'>తాజా సమాచారాన్ని వీక్షించండి</a>.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "sw" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Tazama maelezo ya hivi karibuni</a> kuhusu COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "so" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>La Soco Xogta.</h2>" +
                    $"<p><a href='{covidWebUrl}'>Arag Macluumaadki ugu danbeeyey</a>  oo ku saabsan COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "sm" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Silasila i faamatalaga lata mai</a> o le KOVITI-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "pa" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>ਸੂਚਿਤ ਰਹੋ।</h2>" +
                    $"<p>ਕੋਵਿਡ-19 ਬਾਰੇੇ <a href='{covidWebUrl}'>ਨਵੀਨਤਮ ਜਾਣਕਾਰੀ ਵੇਖੋ</a></p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ps" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p dir='rtl'>دCOVID-19 په<a href='{covidWebUrl}'>اړه تازه معلومات وګورئ</a>.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ur" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p dir='rtl'>کووڈ-19 کے متعلق <a href='{covidWebUrl}'>تازہ ترین معلومات دیکھیں<a/> </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ne" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p>कोभिड-19 बारे <a href='{covidWebUrl}'>नवीनतम जानकारी हेर्नुहोस्</a> ।</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "mxb" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Kunde’e ní tu’un jáá ka</a> siki COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "mh" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2> Pād melele</h2>" +
                    $"<p> <a href='{covidWebUrl}'>Mmat ko rimwik kojjela</a>  ioo COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "mam" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Ettiq’ay jq’umb’aj tumal ma’nxax nex q’umat</a>  tib’aj tx’u’j yab’il tej COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "lo" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>ຕິດຕາມຂ່າວສານ.</h2>" +
                    $"<p><a href='{covidWebUrl}'>ເບິ່ງຂໍ້ມູນຫຼ້າສຸດ</a> ກ່ຽວກັບ ພະຍາດ ໂຄວິດ-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "km" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>ពិនិត្យមើលព័ត៌មានថ្មីៗ​បំផុត</a> ស្តីពីជំងឺ​ COVID-19។</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "kar" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>ကွၢ်တၢ်ဂ့ၢ်တၢ်ကျိၤလၢခံကတၢၢ်</a> ဖဲ COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "fj" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Kila na itukutuku vou duadua ena veika e vauca</a>  na COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "fa" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p dir='rtl'><a href='{covidWebUrl}'> جدیدترین اطلاعات</a>  مربوط به COVID-19 را مشاهده کنید.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "prs" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p dir='rtl'><a href='{covidWebUrl}'>مشاهده آخرین معلومات</a>  درباره کووید-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "chk" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Katon minefon poraus</a> on COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "my" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>နောက်ဆုံးအချက်အလက်များကို ကြည့်မည်</a> ကိုဗစ်-19 အကြောင်း</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "am" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>መረጃ ይኑርዎት።</h2>" +
                    $"<p>በ COVID-19 ላይ <a href='{covidWebUrl}'>የቅርብ ጊዜውን መረጃ ይመልከቱ</a> ።</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "om" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p>COVID-19 ilaalchisee  <a href='{covidWebUrl}'>odeeffannoo haaraa ilaalaa</a>.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "to" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>‘Ilo’i Maʻu Pē.</h2>" +
                    $"<p><a href='{covidWebUrl}'>Vakai ki he fakamatala fakamuimui tahá</a> ’i he COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "ta" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>சமீபத்திய தகவலைப் பார்க்கவும்</a> கொவிட்-19 பற்றி.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "hmn" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p><a href='{covidWebUrl}'>Saib cov ntaub ntawv tawm tshiab tshaj plaws</a> txog kab mob COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "th" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                     ...
                     $"<p><a href='{covidWebUrl}'>ดูข้อมูลล่าสุด</a> เกี่ยวกับโควิด-19</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                     $"<hr>" +
                ...
                _ => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                  ...
                  $"<h2>Stay Informed.</h2>" +
                  $"<p><a href='{covidWebUrl}'>View the latest information</a> on COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                  $"<hr>" +
        ...
        public static string FormatNotFoundHtml(string lang, string webUrl, string contactUsUrl, string vaccineFAQUrl, string covidWebUrl, string emailLogoUrl)
        {
            ...
            return lang switch
            {
                "es" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Registro digital de verificación de COVID-19</h1>" +
                    $"<p>Recientemente solicitó un Registro digital de verificación de COVID-19 del <a href='{webUrl}'>sistema de Registro digital de verificación de COVID-19</a>. Desafortunadamente, la información que ingresó no coincide con la que tenemos en nuestro sistema estatal.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "zh" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>数字 COVID-19 验证记录</h1>" +
                    $"<p>您最近向 <a href='{webUrl}'>数字 COVID-19 验证记录系统</a> 请求过数字 COVID-19 验证记录。很遗憾，您提供的信息与州系统中的信息不符。</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "zh-TW" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>數位 COVID-19 驗證記錄</h1>" +
                    $"<p>您最近向 <a href='{webUrl}'>數位 COVID-19 驗證記錄系統</a> 請求過數位 COVID-19 驗證記錄。很遺憾，您提供的資訊與州系統中的資訊不符。</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>保持關注。</h2>" +
                    $"<p><a href='{covidWebUrl}'>檢視最新資訊</a>，與 COVID-19 密切相關的資訊。</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                    $"<footer><p style='text-align:center'>Washington State Department of Health （華盛頓州衛生部）官方電子郵件</p>" +
                    $"<p style='text-align:center'><img src='{emailLogoUrl}' alt='Washington State Department of Health Logo'></p></footer>",
                "ko" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>디지털 COVID-19 인증 기록</h1>" +
                    $"<p>귀하는 최근 <a href='{webUrl}'>디지털 COVID-19 인증 기록 시스템</a> 에 디지털 COVID-19 인증 기록을 요청하셨습니다. 유감스럽게도 귀하가 제공하신 정보는 주정부 시스템상 정보와 일치하지 않습니다.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "vi" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Hồ sơ Xác nhận COVID-19 kỹ thuật số</h1>" +
                    $"<p>Gần đây bạn yêu cầu Hồ sơ Xác nhận COVID-19 kỹ thuật số từ <a href='{webUrl}'>hệ thống Hồ sơ Xác nhận COVID-19 kỹ thuật số</a>. Rất tiếc, thông tin mà bạn cung cấp không khớp với thông tin có trong hệ thống của tiểu bang.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "ru" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Цифровая запись о вакцинации от COVID-19</h1>" +
                    $"<p>Недавно вы запросили цифровую запись о вакцинации от COVID-19 в <a href='{webUrl}'>системе штата</a>. К сожалению, предоставленная вами информация не совпадает с информацией в системе штата.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "ja" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>COVID-19ワクチン接種電子記録</h1>" +
                    $"<p>あなたは<a href='{webUrl}'>COVID-19ワクチン接種電子記録システム</a>からCOVID-19ワクチン接種電子記録を依頼されましたが、入力された情報はワシントン州のシステムに登録されている情報と一致しません。</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "tr" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Dijital COVID-19 Doğrulama Kaydı</h1>" +
                    $"<p>Yakın zamanda <a href='{webUrl}'>Dijital COVID-19 Doğrulama Kaydı sisteminden</a> bir Dijital COVID-19 Doğrulama Kaydı istediniz. Maalesef verdiğiniz bilgiler eyalet sistemindeki bilgilerle eşleşmiyor.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "ro" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Certificatul digital COVID-19</h1>" +
                    $"<p>Ați solicitat recent un certificat digital COVID-19 de la <a href='{webUrl}'>sistemul de certificate digitale COVID-19</a>. Din păcate, informațiile furnizate de dvs. nu corespund cu datele din sistemul de stat.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "pt" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Comprovante digital de vacinação contra a COVID-19</h1>" +
                    $"<p>Recentemente, você solicitou um Comprovante digital de vacinação contra a COVID-19 do <a href='{webUrl}'>sistema de Comprovante digital de vacinação contra a COVID-19</a>. Infelizmente, as informações fornecidas não correspondem às informações em nosso sistema.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "hi" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>डिजिटल COVID-19 सत्यापन रिकॉर्ड</h1>" +
                    $"<p>आपने हाल ही में <a href='{webUrl}'>डिजिटल COVID-19 सत्यापन रिकॉर्ड प्रणाली </a> से डिजिटल COVID-19 सत्यापन रिकॉर्ड का अनुरोध किया है। दुर्भाग्य से, आपके द्वारा प्रदान की गई जानकारी राज्य प्रणाली की जानकारी से मेल नहीं खाती है। </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "de" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>COVID-19-Digitalzertifikat</h1>" +
                    $"<p>Sie haben kürzlich ein COVID-19-Digitalzertifikat vom <a href='{webUrl}'>COVID-19-Digitalzertifikat-System</a> angefordert. Leider stimmen die von Ihnen gemachten Angaben nicht mit den Informationen im System des Bundesstaats überein.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "te" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>డిజిటల్ కొవిడ్-19 ధృవీకరణ రికార్డ్</h1>" +
                    $"<p>మీరు ఇటీవల <a href='{webUrl}'>డిజిటల్ కొవిడ్-19 ధృవీకరణ రికార్డ్ సిస్టమ్ నుంచ</a> డిజిటల్ కొవిడ్-19 ధృవీకరణ రికార్డ్​ని అభ్యర్ధించారు. దురదృష్టవశాత్తు, మీరు అందించిన సమాచారం స్టేట్ సిస్టమ్​లో సమాచారంతో జతకావడం లేదు.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "sw" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Rekodi ya Kidijitali ya Uthibitishaji wa COVID-19</h1>" +
                    $"<p>Hivi karibuni uliomba Rekodi ya Kidijitali ya Uthibitishaji wa COVID-19 kutoka mfumo wa <a href='{webUrl}'>Rekodi ya Kidijitali ya Uthibitishaji wa COVID-19</a>. Kwa bahati mbaya, maelezo uliyotoa hayalingani na maelezo yaliyopo kwenye mfumo wa jimbo.</a></p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "so" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Diiwaanka Xaqiijinta Tallaalka COVID-19 ee Dhijitaalka Ah</h1>" +
                    $"<p>Waxaad dhawaan ka codsatay Diiwaanka Xaqiijinta Tallaalka COVID-19 ee Dhijitaalka ah <a href='{webUrl}'>Nidaamka Diiwaanka Xaqiijinta Tallaalka COVID-19 ee Dhijitaalka Ah</a> . Nasiib daro, macluumaadka aad bixisay ma waafaqsana macluumaadka kujira nidaamka gobolka. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "sm" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Faamaumauga Faamaonia o le KOVITI-19</h1>" +
                    $"<p>Sa e talosagaina talu ai nei ni faamaumauga faamaonia o le KOVITI-19 <a href='{webUrl}'>Polokalame o faamaumauga o le KOVITI-19</a>. E faamalie atu, o faamatalaga na e tuuina mai, e le tutusa ma faamaumauga i le polokalame a le setete </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "pa" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p>ਤੁਸੀਂ ਹਾਲ ਹੀ ਵਿੱਚ <a href='{webUrl}'>ਡਿਜੀਟਲ ਕੋਵਿਡ-19 ਵੇਰਿਫਿਕੇਸ਼ਨ ਰਿਕਾਰਡ ਸਿਸਟਮ</a> ਤੋਂ ਇੱਕ ਡਿਜੀਟਲ ਕੋਵਿਡ-19 ਵੇਰਿਫਿਕੇਸ਼ਨ ਰਿਕਾਰਡ ਲਈ ਬੇਨਤੀ ਕੀਤੀ ਸੀ। ਬਦਕਿਸਮਤੀ ਨਾਲ, ਤੁਹਾਡੇ ਦੁਆਰਾ ਪ੍ਰਦਾਨ ਕੀਤੀ ਗਈ ਜਾਣਕਾਰੀ ਸਟੇਟ ਦੇ ਸਿਸਟਮ ਵਿੱਚ ਮੌਜੂਦ ਜਾਣਕਾਰੀ ਨਾਲ ਮੇਲ ਨਹੀਂ ਖਾਂਦੀ। </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>ਸੂਚਿਤ ਰਹੋ।</h2>" +
                    $"<p>ਕੋਵਿਡ-19 ਬਾਰੇ <a href='{covidWebUrl}'>ਨਵੀਨਤਮ ਜਾਣਕਾਰੀ ਵੇਖੋ</a></p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                    $"<footer><p style='text-align:center'>Washington State Department of Health (ਵਾਸ਼ਿੰਗਟਨ ਸਟੇਟ ਸਿਹਤ ਵਿਭਾਗ) ਦਾ ਅਧਿਕਾਰਤ ਈਮੇਲ ਪਤਾ</p>" +
                    $"<p style='text-align:center'><img src='{emailLogoUrl}' alt='Washington State Department of Health Logo'></p></footer>",
                "ps" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 dir='rtl' style='color: #C84C0E'>د ډیجیټل COVID-19 تائید ثبت</h1>" +
                    $"<p dir='rtl'>تاسو پدې وروستیو کې <a href='{webUrl}'>د ډیجیټل COVID-19 تائید ثبت سیسټم څخه د ډیجیټل COVID-19 تائید ثبت غوښتنه کړې</a>. له بده مرغه، هغه معلومات چې تاسو چمتو کړي د دولتي سیسټم کې د معلوماتو سره سمون نلري. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "ur" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 dir='rtl' style='color: #C84C0E'>ڈیجیٹل کووڈ-19 تصدیقی ریکارڈ</h1>" +
                    $"<p dir='rtl'>آپ نے حال ہی میں <a href='{webUrl}'>ڈیجیٹل کووڈ-19 تصدیقی ریکارڈ سسٹم</a> سے ڈیجیٹل کووڈ-19 تصدیقی ریکارڈ کی درخواست کی ہے۔ بدقسمتی سے آپ کی فراہم کردہ معلومات ریاستی سسٹم میں موجود معلومات سے مماثلت نہیں رکھتی۔ </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "ne" =>
                    ...
                    $"<h1 style='color: #C84C0E'>डिजिटल कोभिड-19 प्रमाणीकरण रेकर्ड</h1>" +
                    $"<p>तपाईंले हालै <a href='{webUrl}'>डिजिटल कोभिड-19 प्रमाणीकरण रेकर्ड प्रणाली</a> बाट डिजिटल कोभिड-19 प्रमाणीकरण रेकर्डको लागि अनुरोध गर्नुभयो। दुर्भाग्यवश, तपाईंले उपलब्ध गराउनुभएको जानकारी राज्यको प्रणालीमा भएको जानकारीसँग मेल खाँदैन। </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "mh" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p>Eok kiin jeṃaanḷọk kajjitōk a laam jarom COVID-19 jaak jeje jan <a href='{webUrl}'>ko Kaajai COVID-19 Wotom Jeje kkar</a>. jerata, ko melele eok naloma jerbal jab mājet melele for ko konnaan kkar. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>Pad melele.</h2>" +
                    $"<p><a href='{covidWebUrl}'>Mmat ko rimwik kojjela</a> on COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                    $"<footer><p style='text-align:center'>Wōpij Washington State Department of Health (Kutkutton konnaan jikuul in keenki) lota</p>" +
                    $"<p style='text-align:center'><img src='{emailLogoUrl}' alt='Washington State Department of Health Logo'></p></footer>",
                "mam" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "lo" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>ບັນທຶກການຢັ້ງຢືນ ພະຍາດ ໂຄວິດ-19 ແບບດີຈີຕອນ</h1>" +
                    $"<p>ເມື່ອບໍ່ດົນມານີ້ທ່ານໄດ້ຮ້ອງຂໍບັນທຶກການຢັ້ງຢືນ ພະຍາດ ໂຄວິດ-19 ແບບດີຈີຕອນ <a href='{webUrl}'>ລະບົບບັນທຶກການຢັ້ງຢືນ ພະຍາດ ໂຄວິດ-19 ແບບດີຈີຕອນ</a>. ໂຊກບໍ່ດີ, ຂໍ້ມູນທີ່ທ່ານສະໜອງໃຫ້ບໍ່ກົງກັບຂໍ້ມູນຢູ່ໃນລະບົບຂອງລັດ. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "kar" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<p>ဖဲတယံာ်ဒံးဘၣ်နဃ့ထီၣ် ဒံးကၠံၣ်တၢၣ်(လ) COVID-19 တၢ်အုၣ်သးတၢ်မၤနီၣ်မၤဃါ လၢ <a href='{webUrl}'>ဒံးကၠံၣ်တၢၣ်(လ) COVID-19 တၢ်အုၣ်သးတၢ်မၤနီၣ်မၤဃါတၢ်မၤအကျဲသနူ</a> လၢတၢ်တဘူၣ်ဂ့ၤတီၢ်ဘၣ်အပူၤ, တၢ်ဂ့ၢ်တၢ်ကျိၤလၢနဟ့ၣ်လီၤအံၤ တဘၣ်လိာ်ဒီးတၢ်ဂ့ၢ် တၢ်ကျိၤလၢကီၢ်စဲၣ်တၢ်မၤအကျဲသနူအပူၤဘၣ်. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>သ့ၣ်ညါတၢ်ဘိးဘၣ်သ့ၣ်ညါထီဘိ</h2>" +
                    $"<p><a href='{covidWebUrl}'>ကွၢ်တၢ်ဂ့ၢ်တၢ်ကျိၤလၢခံကတၢၢ်</a> ဘၣ်ဃးဒီး COVID-19.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                ...
                "fa" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 dir='rtl' style='color: #C84C0E'>نسخه دیجیتال گواهی واکسیناسیون COVID-19</h1>" +
                    $"<p dir='rtl'>شما به‌تازگی «نسخه دیجیتال گواهی واکسیناسیون COVID-19» را از <a href='{webUrl}'>سیستم نسخه دیجیتال گواهی واکسیناسیون COVID-19</a>  درخواست کرده‌اید. متأسفانه، اطلاعاتی که ارائه کرده‌اید با اطلاعات موجود در سیستم ایالتی مطابقت ندارد. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "prs" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 dir='rtl' style='color: #C84C0E'>سابقه دیجیتل تصدیق کووید-19</h1>" +
                    $"<p dir='rtl'>شما به تازگی فورم سابقه دیجیتل تصدیق کووید-19 را درخواست کردید <a href='{webUrl}'>سیستم سابقه دیجیتل تصدیق کووید-19</a> . متاسفانه، اطلاعاتی که شما ارائه نمودید با اطلاعات سیستم کشور مطابقت ندارد. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "chk" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Digital COVID-19 Afatan Record</h1>" +
                    $"<p>Ke Keran chok tungor ew Digital COVID-19 Afatan Record seni <a href='{webUrl}'>ewe Digital COVID-19 Afatan Record system</a>. Nge, ewe poraus ke awora ese mes ngeni met poraus mi nom non an state ei system ika nenien aisois. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "am" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>ዲጂታል የ COVID-19 ማረጋገጫ መዝገብ</h1>" +
                    $"<p>በቅርቡ ከ<a href='{webUrl}'>ዲጂታል የ COVID-19 ማረጋገጫ መዝገብ ስርዓት</a>  ዲጂታል የ COVID-19 ማረጋገጫ መዝገብ ጠይቀዋል። እንደ አለመታደል ሆኖ ያቀረቡት መረጃ በግዛቱ ሲስተም ውስጥ ካለው መረጃ ጋር አይዛመድም። </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "om" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Mirkaneessa Ragaa Dijitaalaa COVID-19</h1>" +
                    $"<p>Dhiyeenyatti <a href='{webUrl}'>Mala Mirkaneessa Ragaa Dijitaalaa COVID-19</a> irraa Ragaa Mirkaneessa Dijitaalaa COVID-19 gaafattaniirtu. Akka carraa ta’ee, odeeffannoon isin laattan kan siistama keenya keessa jiruun wal hin simu. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "to" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>Digital COVID-19 Verification Record (Lēkooti Fakamo’oni Huhu Malu'i COVID-19)</h1>" +
                    $"<p>Na’a ke toki kolé ni mai ‘a e foomu Lēkooti Fakamo’oni Huhu Malu’i COVID-19 meí he <a href='{webUrl}'>fa’unga tauhi Lēkooti Fakamo’oni Huhu Malu’i COVID-19</a>. Me’apango, ko e fakamatala ‘oku ke ‘omí ‘oku ‘ikai tatau ia mo e fakamatala ‘oku mau tauhí.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "ta" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>மின்னணு Covid-19 சரிபார்ப்புப் பதிவு</h1>" +
                    $"<p>சமீபத்தில் <a href='{webUrl}'>மின்னணு Covid-19 சரிபார்ப்புப் பதிவு அமைப்பிலிருந்த</a> மின்னணு Covid-19 சரிபார்ப்புப் பதிவைக் கோரியுள்ளீர்கள். துரதிர்ஷ்டவசமாக, நீங்கள் வழங்கிய தகவல் மாநில அமைப்பில் உள்ள தகவலுடன் பொருந்தவில்லை. </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    ...
                    $"<h2>தகவலை அறிந்து இருங்கள்.</h2>" +
                    $"<p><a href='{covidWebUrl}'>சமீபத்திய தகவலைப் பார்க்கவும்</a> கொவிட்-19 இல்.</p><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<hr>" +
                    $"<footer><p style='text-align:center'>அதிகாரப்பூர்வ Washington State Department of Health (வாஷிங்டன் மாநில சுகாதாரத் துறை) மின்னஞ்சல்</p>" +
                    $"<p style='text-align:center'><img src='{emailLogoUrl}' alt='Washington State Department of Health Logo'></p></footer>",
                "hmn" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                ...
                "th" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><p style='margin: 0; padding: 0; line-height: 0;' />" +
                    $"<h1 style='color: #C84C0E'>บันทึกการยืนยันเกี่ยวกับโควิด-19 แบบดิจิทัล </h1>" +
                    $"<p>คุณเพิ่งขอบันทึกการยืนยันเกี่ยวกับโควิด-19 แบบดิจิทัลจาก<a href='{webUrl}'>ระบบบันทึกการยืนยันเกี่ยวกับโควิด-19 แบบดิจิทัล</a> ขออภัย ข้อมูลที่คุณให้ไม่ตรงกับข้อมูลในระบบของรัฐ </p><p style='margin: 0; padding: 0; line-height: 0;' />" +
