            ...
            return lang switch
            {
               ...
               "te" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><br/>" +
                ...
                "fa" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><br/>" +
                    ...
                    $"<p dir='rtl'>برای کسب اطلاعات بیشتر در‌مورد «نسخه دیجیتال گواهی واکسیناسیون COVID-19»، از صفحه </a>سؤالات متداول <a href='{vaccineFAQUrl}'>(FAQ)  ما دیدن کنید.</p>" +
        ...
        public static string FormatNotFoundHtml(string lang, string webUrl, string contactUsUrl, string vaccineFAQUrl, string covidWebUrl, string emailLogoUrl)
        {
            ...
            return lang switch
            {
                ...
                "fa" => $"<img src='{webUrl}/imgs/waverifylogo.png' alt='WA Verify Logo'><br/>" +
                    ...
                    $"<h2 dir='rtl'>پرسشی دارید؟</h2>" +
                    $"<p dir='rtl'>برای کسب اطلاعات بیشتر در‌مورد «نسخه دیجیتال گواهی واکسیناسیون COVID-19»، به صفحه </a>سؤالات متداول <a href='{vaccineFAQUrl}'>(FAQ)  ما مراجعه کنید.</p>" +
                    $"<h2 dir='rtl'>آگاه و مطلع بمانید.</h2>" +
                    $"<p dir='rtl'><a href='{covidWebUrl}'>جدیدترین اطلاعات</a>  مربوط به COVID-19 را مشاهده کنید.</p><br/>" +
                    $"<hr>" +
                    $"<footer><p dir='rtl' style='text-align:center'>ایمیل رسمی Washington State Department of Health (اداره سلامت ایالت واشنگتن)</p>" +
