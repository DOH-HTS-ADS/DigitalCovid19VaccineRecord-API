    ...
    public class Utils
    {
        ...
        public static string FormatNotFoundSms(string lang, string phoneNumber)
        {
            ...
            return lang switch
            {
                ...
                "pt" => $"Recentemente, você solicitou ao estado um comprovante digital de vacinação contra a COVID-19. Infelizmente, as informações fornecidas não correspondem às informações em nosso sistema. Entre em contato conosco pelo número 866-397-0337 ou 360-236-3595 para obter ajuda com a correspondência entre os dados de contato e as informações em seu comprovante.",
                ...
                "chk" => $"Ke keran chok tungor echo noum taropwen apposen COVID-19 online seni ewe state. Nge, ewe poraus ke awora ese mes ngeni met poraus mi nom non ach ei system ika nenien aisois. Kokori kich ren ei nampan fon 866-397-0337 ika 360-236-3595 ren aninisin kuta met epwe mes",
