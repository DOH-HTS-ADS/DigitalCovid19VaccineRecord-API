...
|KeySettings__GoogleWalletLogo|The link to the State/Agency Logo that is used in the Google Health Card|https://[your web url]/imgs/ca-logo-660w.png|Logo must be reviewed, approved and white listed by Google Pay Support any time the image is changed. You can do this by contacting support via https://pay.google.com/business/console or emailing them at google-pay-passes-support@google.com 
