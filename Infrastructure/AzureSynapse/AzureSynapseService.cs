...
namespace Infrastructure.AzureSynapse
{
    public class AzureSynapseService : IAzureSynapseService
    {
        ...
        public async Task<Vc> GetVaccineCredentialSubjectAsync(string id, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogInformation($"Trying to connect to Azure Synapse Analytics Database.");
        ...
        public async Task<string> GetVaccineCredentialStatusAsync(SqlConnection conn, GetVaccineCredentialStatusQuery request, CancellationToken cancellationToken)
        {
            string Guid = null;
        ...
        private static DbCommand CreateCommand(SqlConnection conn, GetVaccineCredentialStatusQuery request, string query)
        {
            var cmdVc = conn.CreateCommand();
