...
BEGIN
	...
	BEGIN TRY
        ...
        , vt
		 ...
		 UNION SELECT [ASIIS_VACC_CODE] = 3050, [CDC_VACC_CODE] = 308, [VACCINE_NAME] = N''
		 UNION SELECT [ASIIS_VACC_CODE] = 3051, [CDC_VACC_CODE] = 309, [VACCINE_NAME] = N''
		 UNION SELECT [ASIIS_VACC_CODE] = 3052, [CDC_VACC_CODE] = 310, [VACCINE_NAME] = N''
		 UNION SELECT [ASIIS_VACC_CODE] = 3053, [CDC_VACC_CODE] = 311, [VACCINE_NAME] = N''
		 UNION SELECT [ASIIS_VACC_CODE] = 3054, [CDC_VACC_CODE] = 312, [VACCINE_NAME] = N''
		 UNION SELECT [ASIIS_VACC_CODE] = 3055, [CDC_VACC_CODE] = 313, [VACCINE_NAME] = N''
