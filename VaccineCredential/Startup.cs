...
namespace VaccineCredential.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IMapper autoMapper, TelemetryConfiguration telemetryConfig)
        {
            ...
            builder.UseAdaptiveSampling(maxTelemetryItemsPerSecond: 5, excludedTypes: "Trace");
            builder.Build();
        }
